...
export default class Options {
	constructor() {
		this.value = {
			...
			/**
			 * If defined, this function will be invoked
			 * in which the user can define "patterns" to be used as fill colors
			 *
			 * @memberof Options
			 * @type {Function}
			 * @default undefined
			 ...
			 *
			 *      // This function must return an array of <pattern> elements.

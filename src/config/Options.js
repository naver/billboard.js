	...
	constructor() {
		return {
			...
			*/
			...
			/**
			 * Set stanford options
			 * @name stanford
			 * @memberof Options
			 * @type {Object}
			 * @property {Array} [stanford.lines=[]] Show additional lines anywhere on the chart.<br>
			 ...
			 *
			 * @property {Array} [stanford.regions=[]] Show additional regions anywhere on the chart<br>
			 ...
			 *
			 * @property {Number} [stanford.scaleMin=undefined] Minimum value of the color scale. Default: lowest value in epochs
			 * @property {Number} [stanford.scaleMax=undefined] Maximum value of the color scale. Default: highest value in epochs
			 * @property {Number} [stanford.scaleWidth=20] Width of the color scale
			 * @property {String|Function} [stanford.scaleFormat=undefined] Format of the axis of the color scale. Use 'pow10' to format as powers of 10 or a custom function. Example: d3.format("d")
			 * @property {Function} [stanford.colors=undefined] Set the color of the color scale. This function receives a value between 0 and 1, and should return a color.
			 * @property {Number} [stanford.padding.top=0] Top padding value.
			 * @property {Number} [stanford.padding.right=0] Right padding value.
			 * @property {Number} [stanford.padding.bottom=0] Bottom padding value.
			 * @property {Number} [stanford.padding.left=0] Left padding value.
			 * @see [Demo](https://naver.github.io/billboard.js/demo/#Chart.StanfordDiagram)
			 * @example
			 * stanford: {
             *   scaleMax: 10000,
             *   scaleMin: 1,

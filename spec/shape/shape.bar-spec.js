...
describe("SHAPE BAR", () => {
	...
	describe("multiple xs", () => {
		...
		it("Bars should be positined correctly", () => {
			const expectedPath = [
				"M147.03333333333333,426V39.636363636363626 H166.96666666666667 V426z",
				...
				"M100,426V39.636363636363626 H119.93333333333334 V426z",
				"M200,426V39.636363636363626 H219.93333333333334 V426z",
				"M499,426V39.636363636363626 H518.9333333333334 V426z"
			];
		...
		it("Grouped bars should be positined correctly", () => {
			const expectedPath = [
				"M137.06666666666666,426V168.42424242424244 H176.93333333333334 V426z",
				...
				"M80.06666666666666,297.21212121212125V39.63636363636368 H119.93333333333334 V297.21212121212125z",
				"M180.06666666666666,297.21212121212125V39.63636363636368 H219.93333333333334 V297.21212121212125z",
				"M479.06666666666666,297.21212121212125V39.63636363636368 H518.9333333333334 V297.21212121212125z"
			];
	...
	describe("options", () => {
		...
		it("check the bar radius", () => {
			const path = isMac ? [
				"M233.5,331.55555555555554V380.5833333333333a10,1010010,10H238.5a10,1010010,-10V331.55555555555554z",
				"M251.5,331.55555555555554V223.5a10,1000110,-10H256.5a10,1000110,10V331.55555555555554z"
			] : [
		...
		it("check the axis bar radius in ratio", () => {
			const path = isMac ? [
				"M233.5,331.55555555555554V383.0833333333333a7.5,7.51007.5,7.5H241a7.5,7.51007.5,-7.5V331.55555555555554z",
				"M251.5,331.55555555555554V221a7.5,7.50017.5,-7.5H259a7.5,7.50017.5,7.5V331.55555555555554z"
			] : [

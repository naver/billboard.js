...
var transform = {
    ...
    transformMain: function (withTransition, transitions) {
        ...
        var xAxis = transitions && transitions.axisX ?
            transitions.axisX :
            $T(main.select("." + CLASS.axisX), withTransition);
        var yAxis = transitions && transitions.axisY ?
            transitions.axisY :
            $T(main.select("." + CLASS.axisY), withTransition);
        var y2Axis = transitions && transitions.axisY2 ?
            transitions.axisY2 :
...
var apiZoom = {
    ...
    unzoom: function () {
        var $$ = this.internal;
        var config = $$.config, eventRect = $$.$el.eventRect, $T = $$.$T;
        if ($$.scale.zoom) {
...
var subchart = {
    ...
    transformContext: function (withTransition, transitions) {
        ...
        var subXAxis = transitions && transitions.axisSubX ?

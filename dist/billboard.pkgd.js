...
/* harmony default export */ var src_centroid = (function(polygon) {
  var i = -1,
      n = polygon.length,
      x = 0,
      y = 0,
...
util_extend(ChartInternal_ChartInternal.prototype, {
    ...
    $$.mainText.each(function () {
      ...
      if (cell && this) {
        var _cell$data = slicedToArray_default()(cell.data, 2),
            x = _cell$data[0],
            y = _cell$data[1],
            _d3PolygonCentroid = src_centroid(cell),
        ...
        src_select(this).attr("display", d3_polygon_src_area(cell) < area ? "none" : null).attr("text-anchor", txtAnchor).attr("dy", "0.".concat(angle === 1 ? 71 : 35, "em")).attr("transform", "translate(".concat(xTranslate, ", ").concat(yTranslate, ")"));
      }
    });
  },
  ...
  generateVoronoi: function generateVoronoi(data) {
    ...
    return src_voronoi().extent([min, max]).polygons(data);
  },

  ...
  , _proto.setCulling = function setCulling() {
    ...
    ["subX", "x", "y", "y2"].forEach(function (type) {
      ...
      if (axis && toCull) {
        ...
        if (type === "x") {
          var clipPath = currentMaxTickWidths.x.clipPath ? clip.pathXAxisTickTexts : null;
...
var external_commonjs_d3_dsv_commonjs2_d3_dsv_amd_d3_dsv_root_d3_ = __webpack_require__(7);
...
var external_commonjs_d3_drag_commonjs2_d3_drag_amd_d3_drag_root_d3_ = __webpack_require__(8);
...
/* harmony default export */ var internals_clip = ({
  ...
  setXAxisTickTextClipPathWidth: function setXAxisTickTextClipPathWidth() {
    var $$ = this,
        ...
        svg = $$.$el.svg;
    svg && svg.select("#" + clip.idXAxisTickTexts + " rect").attr("width", currentMaxTickWidths.x.clipPath).attr("height", 30);
  }
});

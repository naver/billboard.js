...
import apiColor from './api/color.js';
import apiData from './api/data.js';
import apiFocus from './api/focus.js';
import apiLegend from './api/legend.js';
import apiLoad from './api/load.js';
import apiShow from './api/show.js';
import apiTooltip from './api/tooltip.js';

...
var focus_default = {
	...
	*/
	defocus(targetIdsValue) {
		...
		$$.$el.svg.selectAll($$.selectorTargets(targetIds.filter($$.isTargetToShow, $$))).classed($FOCUS.focused, false).classed($FOCUS.defocused, true);
	...
	*/
	revert(targetIdsValue) {
		...
		$el.svg.selectAll($$.selectorTargets(targetIds)).classed($FOCUS.focused, false).classed($FOCUS.defocused, false);

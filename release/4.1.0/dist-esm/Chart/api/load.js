...
import { isArray, isEmpty, isString } from "../../module/util/type-checks.js";
import { callDone } from "../../ChartInternal/data/load.js";
//#region src/Chart/api/load.ts
/**
* Copyright (c) 2017 ~ present NAVER Corp.
* billboard.js project is licensed under the MIT license
*/
var load_default = {
	...
	*/
	load(args) {
		...
		if ("categories" in args && $$.axis.isCategorized()) config.axis_x_categories = args.categories;
	...
	*/
	unload(argsValue) {
		...
		if (isArray(args)) args = { ids: args };
		else if (isString(args)) args = { ids: [args] };

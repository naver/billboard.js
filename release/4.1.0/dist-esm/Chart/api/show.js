...
function showHide(show, targetIdsValue, options, skipRedraw = false) {
	...
	if ($$.state.isCanvasMode) {
		if (show && hiddenIds.length) callFn($$.config.data_onshown, this, hiddenIds);
		else if (!show && hiddenIds.length === 0) callFn($$.config?.data_onhidden, this, targetIds);

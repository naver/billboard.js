...
//#region src/ChartInternal/shape/area.ts
/**
* Copyright (c) 2017 ~ present NAVER Corp.
* billboard.js project is licensed under the MIT license
*/
var area_default = {
	...
	*/
	redrawArea(drawFn, withTransition, isSub = false) {
		...
		return [$$.$T(area, withTransition, getRandom()).attr("d", drawFn).style("fill", $$.updateAreaColor.bind($$)).style("opacity", (d) => String($$.isAreaRangeType(d) ? orgAreaOpacity / 1.75 : orgAreaOpacity))];
	},
	/**

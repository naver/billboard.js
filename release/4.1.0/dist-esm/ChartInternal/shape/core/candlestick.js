 ...
 * @version 4.1.0
*/
import { isArray, isNumber, isObject } from "../../../module/util/type-checks.js";
//#region src/ChartInternal/shape/core/candlestick.ts
/**
* Copyright (c) 2017 ~ present NAVER Corp.
* billboard.js project is licensed under the MIT license
*/
	...
	*/
	getCandlestickData({ value }) {
		...
		if (isArray(value)) {
			...
			if (volume !== false) d.volume = volume;
		} else if (isObject(value)) d = { ...value };
		if (d) d._isUp = d.close >= d.open;
		return d || null;
	}
};
//#endregion

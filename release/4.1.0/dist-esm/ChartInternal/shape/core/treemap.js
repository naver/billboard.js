 ...
 * @version 4.1.0
*/
import { hierarchy, treemap, treemapBinary, treemapDice, treemapResquarify, treemapSlice, treemapSliceDice, treemapSquarify } from "d3-hierarchy";
//#region src/ChartInternal/shape/core/treemap.ts
/**
* Copyright (c) 2017 ~ present NAVER Corp.
* billboard.js project is licensed under the MIT license
*/
...
var treemap_default = {
	...
	*/
	initTreemapLayout() {
		this.treemap = treemap().tile(this.getTreemapTile());
	},
	/**
	* Get tiling function
	* @returns {function}
	...
	*/
	getTreemapTile() {
		const { config, state: { current: { width, height } } } = this;
		const tile = {

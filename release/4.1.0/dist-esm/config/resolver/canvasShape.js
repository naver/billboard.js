...
import area_default from "../Options/shape/area.js";
import spline_default from "../Options/shape/spline.js";
import point_default from "../Options/common/point.js";
import line_default from "../Options/shape/line.js";
import { extendAxisModules } from "./axis.core.js";
import bar_default from "../Options/shape/bar.js";
import bubble_default from "../../ChartInternal/shape/core/bubble.js";
import bubble_default$1 from "../Options/shape/bubble.js";
import candlestick_default from "../../ChartInternal/shape/core/candlestick.js";
import candlestick_default$1 from "../Options/shape/candlestick.js";
import scatter_default from "../Options/shape/scatter.js";
import treemap_default from "../../ChartInternal/shape/core/treemap.js";
import treemap_default$1 from "../Options/shape/treemap.js";
//#region src/config/resolver/canvasShape.ts
/**
* Copyright (c) 2017 ~ present NAVER Corp.
* billboard.js project is licensed under the MIT license
*/
...
*/
let line = () => (extendCanvasAxisShape([canvasLineModule], [point_default, line_default]), (line = () => TYPE.LINE)());
/**
* Register modules and options required for canvas spline charts.
* @returns {string} Spline chart type
*/
let spline = () => (extendCanvasAxisShape([canvasLineModule], [
	point_default,
	line_default,
	spline_default
]), (spline = () => TYPE.SPLINE)());
...
*/
let step = () => (extendCanvasAxisShape([canvasLineModule], [point_default, line_default]), (step = () => TYPE.STEP)());
/**
* Register modules and options required for canvas area charts.
* @returns {string} Area chart type
*/
let area = () => (extendCanvasAxisShape([canvasLineModule, canvasAreaModule], [
	point_default,
	line_default,
	area_default
]), (area = () => TYPE.AREA)());
...
*/
let areaLineRange = () => (extendCanvasAxisShape([canvasLineModule, canvasAreaModule], [
	point_default,
	line_default,
	area_default
...
*/
let areaSpline = () => (extendCanvasAxisShape([canvasLineModule, canvasAreaModule], [
	point_default,
	line_default,
	area_default,
	spline_default
...
*/
let areaSplineRange = () => (extendCanvasAxisShape([canvasLineModule, canvasAreaModule], [
	point_default,
	line_default,
	area_default,
	spline_default
...
*/
let areaStep = () => (extendCanvasAxisShape([canvasLineModule, canvasAreaModule], [
	point_default,
	line_default,
	area_default
...
*/
let areaStepRange = () => (extendCanvasAxisShape([canvasLineModule, canvasAreaModule], [
	point_default,
	line_default,
	area_default
...
*/
let bar = () => (extendCanvasAxisShape([canvasBarModule], [bar_default]), (bar = () => TYPE.BAR)());
/**
* Register modules and options required for canvas scatter charts.
* @returns {string} Scatter chart type
*/
let scatter = () => (extendCanvasAxisShape([canvasPointModule], [point_default, scatter_default]), (scatter = () => TYPE.SCATTER)());
/**
* Register modules and options required for canvas bubble charts.
* @returns {string} Bubble chart type
*/
let bubble = () => (extendCanvasAxisShape([canvasPointModule, bubble_default], [point_default, bubble_default$1]), (bubble = () => TYPE.BUBBLE)());
/**
* Register modules and options required for canvas candlestick charts.
* @returns {string} Candlestick chart type
*/
let candlestick = () => (extendCanvasAxisShape([canvasCandlestickModule, candlestick_default], [point_default, candlestick_default$1]), (candlestick = () => TYPE.CANDLESTICK)());
/**
* Register modules and options required for canvas treemap charts.
* @returns {string} Treemap chart type
*/
let treemap = () => (extendCanvasAxisShape([canvasTreemapModule, treemap_default], [treemap_default$1]), (treemap = () => TYPE.TREEMAP)());
//#endregion

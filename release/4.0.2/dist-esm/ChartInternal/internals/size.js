 ...
 * @version 4.0.2
*/
import { $SUBCHART, $AXIS } from '../../config/classes.js';
import { document as doc } from '../../module/browser.js';
import { KEY } from '../../module/Cache.js';
import { isEmpty, isUndefined, isNumber, isString, ceil10 } from '../../module/util/type-checks.js';
...
var size = {
    ...
    getSvgLeft(withoutRecompute) {
        ...
        const needLabelRect = hasAxis && (isString(leftLabel) || isString(leftLabel.text) ||
    ...
    getCurrentPaddingByDirection(type, withoutRecompute = false, withXAxisTickTextOverflow = false) {
        ...
        let padding = hasAxis && isLeftRight && (isAxisInner || (isUndefined(paddingOption) && !isAxisShow)) ?
            0 :
            (isFitPadding ? (isAxisShow ? axisSize : 0) + (paddingOption ?? 0) : (isUndefined(paddingOption) ? axisSize : paddingOption));

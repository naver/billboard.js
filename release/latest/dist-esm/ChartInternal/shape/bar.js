...
import { getStackingBarRadiusSet, getBarRadiusInfo, getBarRadiusResolver } from './core/barRadius.js';
...
var shapeBar = {
    ...
    isStackingRadiusData(d) {
        ...
        // Get sorted list
        const sortedList = $$.orderTargets($$.filterTargetsToShow(data.targets.filter($$.isBarType, $$))).filter(v => keys.indexOf(v.id) > -1);
